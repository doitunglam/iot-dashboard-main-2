...
const waterHeightCtx = document
  .getElementById("waterHeightChart")
  .getContext("2d");
...
const waterHeightChart = new Chart(waterHeightCtx, {
  ...
  options: {
    responsive: false, // Ensures the chart resizes with the window
    maintainAspectRatio: false, // Allow the chart to fill the canvas dimensions
    scales: {
      x: {
        type: "time",
        time: {
